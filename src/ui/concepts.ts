...
export const CONCEPTS: readonly ConceptDefinition[] = [
  ...
  },
  {
    ...
    reciprocal: null,
    undefinedWhen: "A simple ratio can lose the original signs, so arctangent alone cannot tell which of two opposite directions is correct.",
    relatedLesson: "inverse",
    relation: "tangent",
  },
  {
    ...
    plainLanguage: "atan2 receives Y and X separately. Keeping both signs lets it tell which way the vector points on the displayed axes.",
    formula: "θ = atan2(Y, X)",
    reciprocal: null,
